...
> Note: this file is excluded from `scripts/check-no-personal-data.sh`
> by design — it documents the sanitization patch and must name the
> patterns it scrubbed. The exclusion is narrow (only this file + the
> script itself).
